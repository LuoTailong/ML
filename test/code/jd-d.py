...
# 1 导入数据
sale1Data = pd.read_csv("data/jd-d.csv", sep=",", error_bad_lines=False)
...
joblib.dump(dtc, "jd-d.pkl")

# 8 模型可视化
from sklearn.tree import export_graphviz

export_graphviz(dtc, out_file="jd-d.dot", feature_names=x.columns,
