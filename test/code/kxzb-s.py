...
# 1 导入数据
sale1Data = pd.read_csv("test/data/jd-s.csv", sep=",", error_bad_lines=False)
...
joblib.dump(dtc, "kxzb-s.pkl")

# 8 模型可视化
from sklearn.tree import export_graphviz

export_graphviz(dtc, out_file="kxzb-s.dot", feature_names=x.columns,
