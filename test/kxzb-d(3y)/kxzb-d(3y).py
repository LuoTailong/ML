...
# 1 导入数据
sale1Data = pd.read_csv("kxzb-3y.csv", sep=",", error_bad_lines=False)
# sale1Data = pd.read_csv("kxzb-d(3y)-1.csv", sep=",", error_bad_lines=False)
...
# y = sale1Data["17"]
x = sale1Data.drop(columns=["av", "a", "b"], axis=1)
y = sale1Data["av"]
...
export_graphviz(dtc, out_file="kxzb-d.dot", feature_names=x.columns,
                class_names=["C", "CC", "BBB-", "BBB+", "A-", "A", "A+", "AA-", "AA", "AA+", "AAA"], filled=True)
